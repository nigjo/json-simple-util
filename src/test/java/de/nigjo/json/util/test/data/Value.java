...
import de.nigjo.json.util.test.data.RowComponent;
...
public class Value {
    ...
    public String toString() {
        return "{\"name\":\"" + this.name + "\",\"type\":\"" + this.type + "\",\"value\":" + (this.value instanceof String ? new StringBuilder().append("\"").append(this.value).append('\"').toString() : this.value) + (this.components != null ? new StringBuilder().append(",\"components\":").append(AutoGuiDefinition.printArray(this.components)).toString() : "") + '}';
    }
}
