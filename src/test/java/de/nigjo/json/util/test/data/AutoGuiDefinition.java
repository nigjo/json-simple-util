...
import de.nigjo.json.util.test.data.Group;
...
public class AutoGuiDefinition {
    ...
    public String toString() {
        return "{\"title\":\"" + this.getTitle() + "\",\"icon\":\"" + this.getIcon() + "\",\"groups\": " + AutoGuiDefinition.printArray(this.getGroups()) + "}";
    }

    public static String printArray(List<? extends Object> groups) {
        return "[" + groups.stream().map(Object::toString).reduce("", (o, e) -> o.isEmpty() ? e : o + ',' + e) + "]";
    }
}
